...
@pytest.mark.parametrize(
    ...
    (
        (pytest.lazy_fixture("home_url"), pytest.lazy_fixture("client"), HTTPStatus.OK),
        (
...
def test_pages_availability_via_get(url_fixture, parametrized_client, expected_status):
